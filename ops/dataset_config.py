...
ROOT_DATASET = '/home/by/data/'


def return_ucf101(modality):
    filename_categories = 101
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DATASET + 'ucf101TSNframes'
        filename_imglist_train = 'ucf101Labels/ucf101_rgb_train_split_1.txt'
        filename_imglist_val = 'ucf101Labels/ucf101_rgb_val_split_1.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
